        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EmailSource = table.Column<string>(type: "text", nullable: false),
                    LicensePlate = table.Column<string>(type: "text", nullable: false),
                    Vin = table.Column<string>(type: "text", nullable: false),
                    FirstRegistrationDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    IsRegistered = table.Column<bool>(type: "boolean", nullable: false),
                    FollowUpCount = table.Column<int>(type: "integer", nullable: false),
                    InitialMailSent = table.Column<bool>(type: "boolean", nullable: false),
                    InitialMailSentAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    LastMailSentAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    FollowUp1SentAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    FollowUp2SentAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    FollowUp3SentAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    UserId = table.Column<string>(type: "text", nullable: false),
                    FollowUpsEnabled = table.Column<bool>(type: "boolean", nullable: false),
                    ...
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    AutoRegistrationCheckEnabled = table.Column<bool>(type: "boolean", nullable: false),
                    BackgroundRunEveryHours = table.Column<int>(type: "integer", nullable: false),
                    MaxMailsPerRun = table.Column<int>(type: "integer", nullable: false),
                    LastAutomationRunAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true)
                },
                constraints: table =>
                {
